...
public class SwaggerConfig extends WebMvcConfigurationSupport {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("API Pauta Votação")
                .description("API de pauta de votação orientado pela abertura de uma pauta para ser votada" +
                        " durante um determinado período, onde somente pode haver um voto por associado.")
                .version("1.0.0")
                .contact(new Contact("Lucas de Oliveira", null, "lucas_oliveira_gyn@hotmail.com"))
                .build();
    }
